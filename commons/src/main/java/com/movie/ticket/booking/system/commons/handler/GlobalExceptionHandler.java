...
public class GlobalExceptionHandler {
    ...
    public ErrorDTO methodArgumentNotValidException(MethodArgumentNotValidException methodArgumentNotValidException){
        ...
        log.info(LoggerConstants.ENTERED_CONTROLLER_HANDLER_MESSAGE.getValue(),
                "methodArgumentNotValidException",this.getClass(),methodArgumentNotValidException.getAllErrors());
